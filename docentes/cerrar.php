...
<body>
    <header>
        ...
        <div class="text-center-header">
            <h1>Cerrar Sesión</h1>
            <p>¿Estás seguro de que quieres salir de tu cuenta docente?</p>
        </div>
    ...
    <section>
        ...
        <p>Al cerrar sesión, perderás acceso temporal a tu perfil y cursos. Tus datos estarán seguros y podrás volver a iniciar sesión en cualquier momento.</p>
        ...
        <form action="#" method="post">
            <div class="form-block">
                ...
                <div>
                    ...
                    <a href="homedocente.php" class="btn">No, volver al inicio</a>
                </div>
            </div>
        </form>
        ...
        <div class="info">
            ...
            <ul>
                ...
                <li>Los cursos en progreso se guardan automáticamente</li>
            </ul>
        </div>
    </section>
